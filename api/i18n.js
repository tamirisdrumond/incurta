...
const strings = {
  ...
  pt: {
    ...
    // ── QFA — chrome only (food names/portions/categories stay PT for clinical notes) ──
    qfaFormTitle:       'QFA — <em>Frequência Alimentar</em>',
    qfaFormSub:         'Avaliação do seu padrão alimentar habitual',
    qfaBackBtn:         '← Escolher outro questionário',

    qfaStep1Heading:    'Identificação',
    qfaStep1Desc:       'Passo 1 de 3 — Seus dados',
    qfaNomeLabel:       'Nome completo *',
    qfaNomePH:          'Seu nome completo',
    qfaEmailLabel:      'Email *',
    qfaEmailPH:         'seu@email.com',
    qfaStep1Error:      'Por favor, preencha nome e email.',

    qfaHowTitle:        'Como responder:',
    qfaHowUnit:         '· <strong>Unidade de tempo:</strong> D = por dia · S = por semana · M = por mês · N = nunca ou raramente',
    qfaHowFreq:         '· <strong>Frequência:</strong> quantas vezes nessa unidade (1–10)',
    qfaHowPorcao:       '· <strong>Porção:</strong> P = menor que a média · M = igual à média · G = maior · E = bem maior',
    qfaHowNever:        'Se não come ou raramente come um item, selecione <strong>N</strong>.',

    qfaStep2Heading:    'Frequência Alimentar',
    qfaStep2Desc:       'Passo 2 de 3 — Para cada alimento, indique unidade, frequência e porção',
    qfaColFood:         'Alimento',
    qfaColUnit:         'Unidade',
    qfaColUnitSub:      'D / S / M / N',
    qfaColFreq:         'Frequência',
    qfaColFreqSub:      'vezes',
    qfaColPorcao:       'Porção',
    qfaColPorcaoSub:    'P / M / G / E',
    qfaColConsumo:      'Consumo',
    qfaColConsumoSub:   '×/sem',

    qfaStep3Heading:    'Resultado & Perguntas Finais',
    qfaStep3Desc:       'Passo 3 de 3',

    qfaScoreTitle:      'Sua pontuação alimentar',
    qfaScoreCalc:       'A calcular…',
    // Score classification labels (shown to client in score panel)
    qfaScoreExc:        'Excelente base alimentar',
    qfaScoreExcSub:     'Continue assim — foco em comportamento',
    qfaScoreGood:       'Boa base — ajustes pontuais',
    qfaScoreGoodSub:    'Corrija excessos específicos',
    qfaScoreWeak:       'Base fraca — atenção necessária',
    qfaScoreWeakSub:    'Construa a base alimentar gradualmente',
    qfaScoreCrit:       'Padrão crítico',
    qfaScoreCritSub:    'Prioridade: reduzir ultra-processados antes de restringir',
    // Rating labels for score grid
    qfaRatingIdeal:     'ideal',
    qfaRatingGood:      'bom',
    qfaRatingOk:        'ok',
    qfaRatingInsuf:     'insuficiente',
    qfaRatingLow:       'baixo',
    qfaRatingMod:       'moderado',
    qfaRatingHigh:      'alto',
    qfaRatingCrit:      'crítico',
    qfaRatingPerSem:    '×/sem média',
    qfaRatingPts:       'pts',

    qfaOutrosLabel:     'Outros alimentos que come pelo menos 1× por semana (não listados acima)',
    qfaOutrosPH:        'Alimento | Frequência por semana | Quantidade',
    qfaGorduraLabel:    'Quando come carne ou frango, costuma comer a gordura visível?',
    qfaGorduraOpt1:     '1 — Nunca ou raramente',
    qfaGorduraOpt2:     '2 — Algumas vezes',
    qfaGorduraOpt3:     '3 — Sempre',
    qfaGorduraOpt4:     '9 — Não sabe',
    qfaPeriodoLabel:    'Em qual período você mais come?',
    qfaPeriodoOpt1:     'Manhã',
    qfaPeriodoOpt2:     'Tarde',
    qfaPeriodoOpt3:     'Noite',
    qfaPeriodoOpt4:     'Mais tarde após o jantar',

    qfaVerResultBtn:    'Ver resultado →',
    qfaSubmitBtn:       'Enviar respostas →',
    qfaErrorMsg:        'Erro ao enviar. Tente novamente ou contacte a Tamiris.',

    qfaSuccessTitle:    'Obrigada por preencher!',
    qfaSuccessText:     'Suas respostas foram registradas. A Tamiris irá analisá-las antes da sua consulta.',
    qfaSuccessBackBtn:  'Preencher outro questionário',
  },
  ...
  es: {
    ...
    // ── QFA — chrome only ─────────────────────────────────────────────────────
    qfaFormTitle:       'CFA — <em>Frecuencia Alimentaria</em>',
    qfaFormSub:         'Evaluación de tu patrón alimentario habitual',
    qfaBackBtn:         '← Elegir otro cuestionario',

    qfaStep1Heading:    'Identificación',
    qfaStep1Desc:       'Paso 1 de 3 — Tus datos',
    qfaNomeLabel:       'Nombre completo *',
    qfaNomePH:          'Tu nombre completo',
    qfaEmailLabel:      'Email *',
    qfaEmailPH:         'tu@email.com',
    qfaStep1Error:      'Por favor, completa nombre y email.',

    qfaHowTitle:        '¿Cómo responder?',
    qfaHowUnit:         '· <strong>Unidad de tiempo:</strong> D = por día · S = por semana · M = por mes · N = nunca o raramente',
    qfaHowFreq:         '· <strong>Frecuencia:</strong> cuántas veces en esa unidad (1–10)',
    qfaHowPorcao:       '· <strong>Porción:</strong> P = menor que el promedio · M = igual al promedio · G = mayor · E = mucho mayor',
    qfaHowNever:        'Si no consumes o raramente consumes un alimento, selecciona <strong>N</strong>.',

    qfaStep2Heading:    'Frecuencia Alimentaria',
    qfaStep2Desc:       'Paso 2 de 3 — Para cada alimento, indica unidad, frecuencia y porción',
    qfaColFood:         'Alimento',
    qfaColUnit:         'Unidad',
    qfaColUnitSub:      'D / S / M / N',
    qfaColFreq:         'Frecuencia',
    qfaColFreqSub:      'veces',
    qfaColPorcao:       'Porción',
    qfaColPorcaoSub:    'P / M / G / E',
    qfaColConsumo:      'Consumo',
    qfaColConsumoSub:   '×/sem',

    qfaStep3Heading:    'Resultado y Preguntas Finales',
    qfaStep3Desc:       'Paso 3 de 3',

    qfaScoreTitle:      'Tu puntuación alimentaria',
    qfaScoreCalc:       'Calculando…',
    qfaScoreExc:        'Excelente base alimentaria',
    qfaScoreExcSub:     'Continúa así — enfócate en el comportamiento',
    qfaScoreGood:       'Buena base — ajustes puntuales',
    qfaScoreGoodSub:    'Corrige excesos específicos',
    qfaScoreWeak:       'Base débil — atención necesaria',
    qfaScoreWeakSub:    'Construye la base alimentaria gradualmente',
    qfaScoreCrit:       'Patrón crítico',
    qfaScoreCritSub:    'Prioridad: reducir ultraprocesados antes de restringir',
    qfaRatingIdeal:     'ideal',
    qfaRatingGood:      'bueno',
    qfaRatingOk:        'ok',
    qfaRatingInsuf:     'insuficiente',
    ...
    qfaRatingHigh:      'alto',
    qfaRatingCrit:      'crítico',
    qfaRatingPerSem:    '×/sem promedio',
    qfaRatingPts:       'pts',

    qfaOutrosLabel:     'Otros alimentos que comes al menos 1× por semana (no listados arriba)',
    qfaOutrosPH:        'Alimento | Frecuencia por semana | Cantidad',
    qfaGorduraLabel:    'Cuando comes carne o pollo, ¿sueles comer la grasa visible?',
    qfaGorduraOpt1:     '1 — Nunca o raramente',
    qfaGorduraOpt2:     '2 — Algunas veces',
    qfaGorduraOpt3:     '3 — Siempre',
    qfaGorduraOpt4:     '9 — No sabe',
    qfaPeriodoLabel:    '¿En qué período del día comes más?',
    qfaPeriodoOpt1:     'Mañana',
    qfaPeriodoOpt2:     'Tarde',
    qfaPeriodoOpt3:     'Noche',
    qfaPeriodoOpt4:     'Más tarde después de cenar',

    qfaVerResultBtn:    'Ver resultado →',
    qfaSubmitBtn:       'Enviar respuestas →',
    qfaErrorMsg:        'Error al enviar. Inténtalo de nuevo o contacta a Tamiris.',

    qfaSuccessTitle:    '¡Gracias por completar!',
    qfaSuccessText:     'Tus respuestas han sido registradas. Tamiris las analizará antes de tu consulta.',
    qfaSuccessBackBtn:  'Rellenar otro cuestionario',
  },
};
